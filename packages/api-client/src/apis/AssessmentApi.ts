...
export class AssessmentApi extends runtime.BaseAPI implements AssessmentApiInterface {
     ...
     * List assessments
     */
    async listAssessmentsRaw(requestParameters: ListAssessmentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Assessment>>> {
        const queryParameters: any = {};
     ...
     * List assessments
     */
    async listAssessments(requestParameters: ListAssessmentsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Assessment>> {
