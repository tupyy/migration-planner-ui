...
export interface VMs {
     ...
     * @memberof VMs
     */
    powerStates: { [key: string]: number; } | null;
    /**
     * 
     * @type {{ [key: string]: number; }}
     * @memberof VMs
...
export function VMsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VMs {
    ...
    return {
        ...
        'notMigratableReasons': (json['notMigratableReasons'] == null ? null : (json['notMigratableReasons'] as Array<any>).map(MigrationIssueFromJSON)),
        'migrationWarnings': (json['migrationWarnings'] == null ? null : (json['migrationWarnings'] as Array<any>).map(MigrationIssueFromJSON)),
    };
}
...
export function VMsToJSONTyped(value?: VMs | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'notMigratableReasons': (value['notMigratableReasons'] == null ? null : (value['notMigratableReasons'] as Array<any>).map(MigrationIssueToJSON)),
        'migrationWarnings': (value['migrationWarnings'] == null ? null : (value['migrationWarnings'] as Array<any>).map(MigrationIssueToJSON)),
    };
}
